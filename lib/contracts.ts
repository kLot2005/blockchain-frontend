...
export const CROWDTOKEN_ADDRESS = process.env.NEXT_PUBLIC_CROWDTOKEN_ADDRESS as string;
export const CROWDFUNDING_ADDRESS = process.env.NEXT_PUBLIC_CROWDFUNDING_ADDRESS as string;
